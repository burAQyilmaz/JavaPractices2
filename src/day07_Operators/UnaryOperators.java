...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        System.out.println(c++); // post increment: first basement the current value, then increases the value by 1 right
        ...
        System.out.println(y--); // post decrement: first basement the current value, then decreases the value by 1 right

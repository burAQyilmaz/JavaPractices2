...
public class ScrumTeam {
     ...
     */
    public String PD, BA, SM;
    ArrayList<Tester> testersList = new ArrayList<>();
    ArrayList<Developer> devopsList = new ArrayList<>();
    public int daysOfSprint;

    public ScrumTeam(String PD, String BA, String SM, int daysOfSprint) {
        this.PD = PD;
        this.BA = BA;
        this.SM = SM;
    ...
    public void removeTester(long employeeID) {
        ...
        testersList.removeIf(i -> i.employeeID == employeeID);
    }

    public void removeDeveloper(long employeeID) {
        devopsList.removeIf(i -> i.employeeID == employeeID);
    }
